...
function silver(){
		document.getElementById("imagess").src="../resources/images/estimate/venue/venue_silver.png";
}
function blue(){
	document.getElementById("imagess").src="../resources/images/estimate/venue/venue_blue.png";
}
function yellow(){
	document.getElementById("imagess").src="../resources/images/estimate/venue/venue_yellow.png";
}
function black(){
	document.getElementById("imagess").src="../resources/images/estimate/venue/venue_black.png";
}
function white(){
	document.getElementById("imagess").src="../resources/images/estimate/venue/venue_white.png";
}
			...
			<section>
				<div>
					<header>
						<div>
							<h2>베뉴 Smart</h2>
							<span style="color: gray;">베뉴 가솔린 1.6 Smart 2WD 메뉴얼</span>
						</div>
						<div align="right">
							<span style="font-size: 19px;">차량 가격</span><b style="font-size: 30px; margin-left: 30px;">15,000,000 원</b>
						</div>
					</header>
				</div>
				<div align="right">
				...
				<div>
				<img id="imagess" src="../resources/images/estimate/venue/venue_silver.png">
				</div>
				<div>
			...
			<form  id="option" action="../prices/savePrice" method="post">
				<ul>
					...
					<li><p><b>차량 종류</b></p><select name="car">
							<option value="베뉴 가솔린 1.6 Smart 2WD 메뉴얼">베뉴</option>
					</select></li>
					<br>
						...
						<ul>
							<li>
								<button class="inner_color" onclick="silver();"	
									style="background: url('../resources/images/estimate/venue/silver-exterior.png');"></button>
							</li>
							<li>
								<button class="inner_color" onclick="blue();"
									style="background: url('../resources/images/estimate/venue/blue-exterior.png');"></button>
							</li>
							<li>
								<button class="inner_color" onclick="yellow();"
									style="background: url('../resources/images/estimate/venue/yellow-exterior.png');"></button>
							</li>
							<li>
								<button class="inner_color" onclick="black();"
									style="background: url('../resources/images/estimate/venue/black-exterior.png');"></button>
							</li>
							<li>
								<button class="inner_color" onclick="white();"
									style="background: url('../resources/images/estimate/venue/white-exterior.png');"></button>
							</li>
						</ul>
					</div>
				</div>
