...
function silver(){
		document.getElementById("imagess").src="../resources/images/estimate/kona/kona_silver.png";
}
function blue(){
	document.getElementById("imagess").src="../resources/images/estimate/kona/kona_blue.png";
}
function chowhite(){
	document.getElementById("imagess").src="../resources/images/estimate/kona/kona_chowhite.png";
}
function sblue(){
	document.getElementById("imagess").src="../resources/images/estimate/kona/kona_sblue.png";
}
function red(){
	document.getElementById("imagess").src="../resources/images/estimate/kona/kona_red.png";
}
			...
			<section>
				<div>
					<header>
						<div>
							<h2>코나 Smart</h2>
							<span style="color: gray;">코나 가솔린 1.6 터보 Smart 2WD 오토</span>
						</div>
						<div align="right">
							<span style="font-size: 19px;">차량 가격</span><b style="font-size: 30px; margin-left: 30px;">19,500,000 원</b>
						</div>
					</header>
				</div>
				<div align="right">
				...
				<div>
				<img id="imagess" src="../resources/images/estimate/kona/kona_silver.png">
				</div>
				<div>
			...
			<form  id="option" action="../prices/savePrice" method="post">
				<ul>
					...
					<li><p><b>차량 종류</b></p><select name="car">
							<option value="코나 가솔린 1.6 터보 Smart 2WD 오토">코나</option>
					</select></li>
					<br>
					<li><p><b>차량 색</b></p><select name="color">
							<option value="silver">silver</option>
							<option value="blue">blue</option>
							<option value="chowhite">chowhite</option>
			...
			<section>
				<div>
					...
					<div>
						<ul>
							<li>
								<button class="inner_color" onclick="silver();"	
									style="background: url('../resources/images/estimate/kona/silver-exterior.png');"></button>
							</li>
							<li>
								<button class="inner_color" onclick="blue();"
									style="background: url('../resources/images/estimate/kona/blue-exterior.png');"></button>
							</li>
							<li>
								<button class="inner_color" onclick="chowhite();"
									style="background: url('../resources/images/estimate/kona/chowhite-exterior.png');"></button>
							</li>
							<li>
								<button class="inner_color" onclick="sblue();"
									style="background: url('../resources/images/estimate/kona/sblue-exterior.png');"></button>
							</li>
							<li>
								<button class="inner_color" onclick="red();"
									style="background: url('../resources/images/estimate/kona/red-exterior.png');"></button>
							</li>
						</ul>
					</div>
				</div>
