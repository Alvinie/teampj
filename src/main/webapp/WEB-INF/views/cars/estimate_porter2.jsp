...
function cwhite(){
		document.getElementById("imagess").src="../resources/images/estimate/porter2/porter2_white.png";
}
		...
		<div align="left" class="left_menu">
			...
			<section>
				<div>
					<header>
						<div>
							<h2>포터 2 Electric 스마트스페셜</h2>
							<span style="color: gray;">포터2 Electric 초장축 슈퍼캡 일렉트릭 오토 스마트스페셜</span>
						</div>
						<div align="right">
							<span style="font-size: 19px;">차량 가격</span><b style="font-size: 30px; margin-left: 30px;">40,600,000 원</b>
						</div>
					</header>
				</div>
				<div align="right">
				...
				<div>
				<img id="imagess" src="../resources/images/estimate/porter2/porter2_cwhite.png">
				</div>
				<div>
			...
			<form  id="option" action="../prices/savePrice" method="post">
				<ul>
					...
					<li><p><b>차량 종류</b></p><select name="car">
							<option value="포터2 Electric 초장축 슈퍼캡 일렉트릭 오토 스마트스페셜">포터2</option>
					</select></li>
					<br>
					<li><p><b>차량 색</b></p><select name="color">
							<option value="cwhtie">cwhtie</option>
					</select></li>
					<p><b>추가 옵션</b></p>
					<div>
			...
			<section>
				<div>
					...
					<div>
						<ul>
							<li>
								<button class="inner_color" onclick="cwhtie();"	
									style="background: url('resources/images/estimate/porter2/cwhite-exterior.png');"></button>
							</li>
						</ul>
					</div>
				</div>
