...
function white(){
		document.getElementById("imagess").src="../resources/images/estimate/sonata/sonata_white.png";
}
function black(){
	document.getElementById("imagess").src="../resources/images/estimate/sonata/sonata_black.png";
}
function ngray(){
	document.getElementById("imagess").src="../resources/images/estimate/sonata/sonata_녹턴그레이.png";
}
function blue(){
	document.getElementById("imagess").src="../resources/images/estimate/sonata/sonata_옥스퍼드블루.png";
}
function gray(){
	document.getElementById("imagess").src="../resources/images/estimate/sonata/sonata_gray.png";
}
			...
			<section>
				<div>
					<header>
						<div>
							<h2>쏘나타 Smart</h2>
							<span style="color: gray;">쏘나타 자가용 스마트스트림 가솔린 2.0 Smart</span>
						</div>
						<div align="right">
							<span style="font-size: 19px;">차량 가격</span><b style="font-size: 30px; margin-left: 30px;">24,300,000 원</b>
						</div>
					</header>
				</div>
				<div align="right">
				...
				<div>
				<img id="imagess" src="../resources/images/estimate/sonata/sonata_녹턴그레이.png">
				</div>
				<div>
			...
			<form  id="option" action="../prices/savePrice" method="post">
				<ul>
					...
					<li><p><b>차량 종류</b></p><select name="car">
							<option value="쏘나타 자가용 스마트스트림 가솔린 2.0 Smart">쏘나타</option>
					</select></li>
					<br>
					<li><p><b>차량 색</b></p><select name="color">
							<option value="white">white</option>
							<option value="black">black</option>
							<option value="ngray">ngray</option>
						...
						<ul>
							<li>
								<button class="inner_color" onclick="white();"	
									style="background: url('../resources/images/estimate/sonata/white-exterior.png');"></button>
							</li>
							<li>
								<button class="inner_color" onclick="black();"
									style="background: url('../resources/images/estimate/sonata/black-exterior.png');"></button>
							</li>
							<li>
								<button class="inner_color" onclick="ngray();"
									style="background: url('../resources/images/estimate/sonata/녹턴그레이-exterior.png');"></button>
							</li>
							<li>
								<button class="inner_color" onclick="blue();"
									style="background: url('../resources/images/estimate/sonata/옥스퍼드블루-exterior.png');"></button>
							</li>
							<li>
								<button class="inner_color" onclick="gray();"
									style="background: url('../resources/images/estimate/sonata/gray-exterior.png');"></button>
							</li>
						</ul>
					</div>
				</div>
