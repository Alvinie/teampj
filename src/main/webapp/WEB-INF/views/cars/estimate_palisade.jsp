...
function sb(){
		document.getElementById("imagess").src="../resources/images/estimate/palisade/palisade_sb.png";
}
function sgri(){
	document.getElementById("imagess").src="../resources/images/estimate/palisade/palisade_sgri.png";
}
function black(){
	document.getElementById("imagess").src="../resources/images/estimate/palisade/palisade_black.png";
}
function mcloud(){
	document.getElementById("imagess").src="../resources/images/estimate/palisade/palisade_mcloud.png";
}
function white(){
	document.getElementById("imagess").src="../resources/images/estimate/palisade/palisade_white.png";
}
		...
		<div align="left" class="left_menu">
			...
			<section>
				<div>
					<header>
						<div>
							<h2>팰리세이드 Exclusive</h2>
							<span style="color: gray;">팰리세이드 가솔린 3.8 2WD 오토 Exclusive 8인승</span>
						</div>
						<div align="right">
							<span style="font-size: 19px;">차량 가격</span><b style="font-size: 30px; margin-left: 30px;">36,400,000 원</b>
						</div>
					</header>
				</div>
				<div align="right">
				...
				<div>
				<img id="imagess" src="../resources/images/estimate/palisade/palisade_sb.png">
				</div>
				<div>
			...
			<form  id="option" action="../prices/savePrice" method="post">
				<ul>
					...
					<li><p><b>차량 종류</b></p><select name="car">
							<option value="팰리세이드 가솔린 3.8 2WD 오토 Exclusive 8인승T">팰리세이드</option>
					</select></li>
					<br>
					<li><p><b>차량 색</b></p><select name="color">
							<option value="sb">sb</option>
							<option value="sgri">sgri</option>
			...
			<section>
				<div>
					...
					<div>
						<ul>
							<li>
								<button class="inner_color" onclick="sb();"	
									style="background: url('../resources/images/estimate/palisade/sb-exterior.png');"></button>
							</li>
							<li>
								<button class="inner_color" onclick="sgri();"
									style="background: url('../resources/images/estimate/palisade/sgri-exterior.png');"></button>
							</li>
							<li>
								<button class="inner_color" onclick="black();"
									style="background: url('../resources/images/estimate/palisade/black-exterior.png');"></button>
							</li>
							<li>
								<button class="inner_color" onclick="mcloud();"
									style="background: url('../resources/images/estimate/palisade/mcloud-exterior.png');"></button>
							</li>
							<li>
								<button class="inner_color" onclick="white();"
									style="background: url('../resources/images/estimate/palisade/white-exterior.png');"></button>
							</li>
						</ul>
					</div>
				</div>
