...
function gray(){
		document.getElementById("imagess").src="../resources/images/estimate/veloster/veloster_gray.png";
}
function darknight(){
	document.getElementById("imagess").src="../resources/images/estimate/veloster/veloster_다크나이트.png";
}
function chowhite(){
	document.getElementById("imagess").src="../resources/images/estimate/veloster/veloster_초코화이트.png";
}
			...
			<section>
				<div>
					<header>
						<div>
							<h2>벨로스터 Modern</h2>
							<span style="color: gray;">벨로스터 가솔린 1.4 터보 Modern DCT 원톤</span>
						</div>
						<div align="right">
							<span style="font-size: 19px;">차량 가격</span><b style="font-size: 30px; margin-left: 30px;">21,350,000 원</b>
						</div>
					</header>
				</div>
				<div align="right">
				...
				<div>
				<img id="imagess" src="../resources/images/estimate/veloster/veloster_gray.png">
				</div>
				<div>
			...
			<form  id="option" action="../prices/savePrice" method="post">
				<ul>
					...
					<li><p><b>차량 종류</b></p><select name="car">
							<option value="벨로스터 가솔린 1.4 터보 Modern DCT 원톤">벨로스터</option>
					</select></li>
					<br>
						...
						<ul>
							<li>
								<button class="inner_color" onclick="gray();"	
									style="background: url('../resources/images/estimate/veloster/gray-exterior.png');"></button>
							</li>
							<li>
								<button class="inner_color" onclick="darknight();"
									style="background: url('../resources/images/estimate/veloster/다크나이트-exterior.png');"></button>
							</li>
							<li>
								<button class="inner_color" onclick="chowhite();"
									style="background: url('../resources/images/estimate/veloster/초코화이트-exterior.png');"></button>
							</li>
						</ul>
					</div>
				</div>
