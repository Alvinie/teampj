...
function tgray(){
		document.getElementById("imagess").src="../resources/images/estimate/nexo/nexo_tgray.png";
}
			...
			<section>
				<div>
					<header>
						<div>
							<h2>넥쏘 Modern</h2>
							<span style="color: gray;">넥쏘 자가용 5인승 수소전기 오토 오토 MOdern</span>
						</div>
						<div align="right">
							<span style="font-size: 19px;">차량 가격</span><b style="font-size: 30px; margin-left: 30px;">73,578,500 원</b>
						</div>
					</header>
				</div>
				<div align="right">
				...
				<div>
				<img id="imagess" src="../resources/images/estimate/nexo/nexo_tgray.png">
				</div>
				<div>
			...
			<form  id="option" action="../prices/savePrice" method="post">
				<ul>
					...
					<li><p><b>차량 종류</b></p><select name="car">
							<option value="넥쏘 자가용 5인승 수소전기 오토 오토 MOdern">넥쏘</option>
					</select></li>
					<br>
					<li><p><b>차량 색</b></p><select name="color">
							<option value="tgray">tgray</option>
					</select></li>
					<p><b>추가 옵션</b></p>
					<div>
			...
			<section>
				<div>
					...
					<div>
						<ul>
							<li>
								<button class="inner_color" onclick="tgray();"	
									style="background: url('resources/images/estimate/nexo/tgray-exterior.png');"></button>
							</li>
						</ul>
					</div>
				</div>
