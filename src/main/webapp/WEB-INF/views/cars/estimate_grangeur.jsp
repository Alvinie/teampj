...
function gray(){
		document.getElementById("imagess").src="../resources/images/estimate/grangeur/grangeur_햄턴그레이.png";
}
function osblue(){
	document.getElementById("imagess").src="../resources/images/estimate/grangeur/grangeur_옥스퍼드블루.png";
}
function black(){
	document.getElementById("imagess").src="../resources/images/estimate/grangeur/grangeur_black.png";
}
function white(){
	document.getElementById("imagess").src="../resources/images/estimate/grangeur/grangeur_white.png";
}
			...
			<section>
				<div>
					<header>
						<div>
							<h2>그랜저 Premium</h2>
							<span style="color: gray;">그랜저 자가용 가솔린 2.5</span>
						</div>
						<div align="right">
							<span style="font-size: 19px;">차량 가격</span><b style="font-size: 30px; margin-left: 30px;">36,450,000 원</b>
						</div>
					</header>
				</div>
				<div align="right">
				...
				<div>
				<img id="imagess" src="../resources/images/estimate/grangeur/grangeur_햄턴그레이.png">
				</div>
				<div>
			...
			<form  id="option" action="../prices/savePrice" method="post">
				<ul>
					...
					<li><p><b>차량 종류</b></p><select name="car">
							<option value="그랜저 자가용 가솔린 2.5">그랜저</option>
					</select></li>
					<br>
					<li><p><b>차량 색</b></p><select name="color">
							<option value="gray">gray</option>
							<option value="osblue">osblue</option>
							<option value="black">black</option>
							<option value="white">white</option>
					</select></li>
					<p><b>추가 옵션</b></p>
					<div>
					<input type="hidden" name="userId" value="${member.userId }">					<li><input type="checkbox" name="option1" value="7단 DCT">7단DCT</li><br>
						...
						<ul>
							<li>
								<button class="inner_color" onclick="gray();"	
									style="background: url('../resources/images/estimate/grangeur/햄턴그레이-exterior.png');"></button>
							</li>
							<li>
								<button class="inner_color" onclick="osblue();"
									style="background: url('../resources/images/estimate/grangeur/옥스퍼드블루-exterior.png');"></button>
							</li>
							<li>
								<button class="inner_color" onclick="black();"
									style="background: url('../resources/images/estimate/grangeur/black-exterior.png');"></button>
							</li>
							<li>
								<button class="inner_color" onclick="white();"
									style="background: url('../resources/images/estimate/grangeur/white-exterior.png');"></button>
							</li>
						</ul>
					</div>
				</div>
