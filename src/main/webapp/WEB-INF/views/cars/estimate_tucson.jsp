...
function black(){
		document.getElementById("imagess").src="../resources/images/estimate/tucson/tucson_black.png";
}
function whitec(){
	document.getElementById("imagess").src="../resources/images/estimate/tucson/tucson_whitec.png";
}
function pwhite(){
	document.getElementById("imagess").src="../resources/images/estimate/tucson/tucson_pwhite.png";
}
function dblue(){
	document.getElementById("imagess").src="../resources/images/estimate/tucson/tucson_dblue.png";
}
function gray(){
	document.getElementById("imagess").src="../resources/images/estimate/tucson/tucson_gray.png";
}
			...
			<section>
				<div>
					<header>
						<div>
							<h2>투싼 Smart</h2>
							<span style="color: gray;">투싼 가솔린 1.6 터보 Smart 2WD DCT</span>
						</div>
						<div align="right">
							<span style="font-size: 19px;">차량 가격</span><b style="font-size: 30px; margin-left: 30px;">22,970,000 원</b>
						</div>
					</header>
				</div>
				<div align="right">
				...
				<div>
				<img id="imagess" src="../resources/images/estimate/tucson/tucson_black.png">
				</div>
				<div>
			...
			<form  id="option" action="../prices/savePrice" method="post">
				<ul>
					...
					<li><p><b>차량 종류</b></p><select name="car">
							<option value="투싼 가솔린 1.6 터보 Smart 2WD DCT">투싼</option>
					</select></li>
					<br>
					<li><p><b>차량 색</b></p><select name="color">
							<option value="black">black</option>
							<option value="whitec">whitec</option>
							<option value="pwhite">pwhite</option>
						...
						<ul>
							<li>
								<button class="inner_color" onclick="black();"	
									style="background: url('../resources/images/estimate/tucson/black-exterior.png');"></button>
							</li>
							<li>
								<button class="inner_color" onclick="whitec();"
									style="background: url('../resources/images/estimate/tucson/whitec-exterior.png');"></button>
							</li>
							<li>
								<button class="inner_color" onclick="pwhite();"
									style="background: url('../resources/images/estimate/tucson/pwhite-exterior.png');"></button>
							</li>
							<li>
								<button class="inner_color" onclick="dblue();"
									style="background: url('../resources/images/estimate/tucson/dblue-exterior.png');"></button>
							</li>
							<li>
								<button class="inner_color" onclick="gray();"
									style="background: url('../resources/images/estimate/tucson/gray-exterior.png');"></button>
							</li>
						</ul>
					</div>
				</div>
