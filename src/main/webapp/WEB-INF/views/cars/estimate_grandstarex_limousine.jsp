...
function metal(){
		document.getElementById("imagess").src="../resources/images/estimate/grandstarex_limousine/grandstarex_limousine_black.png";
}
		...
		<div align="left" class="left_menu">
			...
			<section>
				<div>
					<header>
						<div>
							<h2>그랜드 스타렉스 Limousine Exclusive</h2>
							<span style="color: gray;">그랜드 스타렉스 Limousine Exclusive</span>
						</div>
						<div align="right">
							<span style="font-size: 19px;">차량 가격</span><b style="font-size: 30px; margin-left: 30px;">41,850,000 원</b>
						</div>
					</header>
				</div>
				<div align="right">
				...
				<div>
				<img id="imagess" src="../resources/images/estimate/grandstarex_limousine/grandstarex_limousine_black.png">
				</div>
				<div>
			...
			<form  id="option" action="../prices/savePrice" method="post">
				<ul>				
					<li><p><b>차량 종류</b></p><select name="car">
							<option value="그랜드 스타렉스 Limousine Exclusive">그랜드 스타렉스 Limousine</option>
					</select></li>
					<br>
						...
						<ul>
							<li>
								<button class="inner_color" onclick="metal();"	
									style="background: url('../resources/images/estimate/grandstarex_limousine/black-exterior.png');"></button>
							</li>
						</ul>
					</div>
				</div>
