...
function white(){
		document.getElementById("imagess").src="../resources/images/estimate/i30/i30_white.png";
}
function black(){
	document.getElementById("imagess").src="../resources/images/estimate/i30/i30_black.png";
}
function red(){
	document.getElementById("imagess").src="../resources/images/estimate/i30/i30_red.png";
}
function blue(){
	document.getElementById("imagess").src="../resources/images/estimate/i30/i30_blue.png";
}
function gray(){
	document.getElementById("imagess").src="../resources/images/estimate/i30/i30_아마존그레이.png";
}
...
function estiSave(){
	...
	var count= con.option.length;
	for(var i = 0; i<count; i++){
		if(con.option[i].checked ==false){
			con.option[i].value='x';
			con.option[i].checked=true;
		}
		console.log(con.option[i].value)
	}
	con.submit();
}
			...
			<section>
				<div>
					<header>
						<div>
							<h2>i30 N Line</h2>
							<span style="color: gray;">i30 가솔린 1.6 터보 N Line DCT</span>
						</div>
						<div align="right">
							<span style="font-size: 19px;">차량 가격</span><b style="font-size: 30px; margin-left: 30px;">24,230,000 원</b>
						</div>
					</header>
				</div>
				<div align="right">
				...
				<div>
				<img id="imagess" src="../resources/images/estimate/i30/i30_white.png">
				</div>
				<div>
			...
			<form  id="option" action="../prices/savePrice" method="post">
				<ul>
					...
					<li><p><b>차량 종류</b></p><select name="carName">
							<option value="i30 가솔린 1.6 터보 N Line DCT">i30</option>
					</select></li>
					<br>
						...
						<ul>
							<li>
								<button class="inner_color" onclick="white();"	
									style="background: url('../resources/images/estimate/i30/white-exterior.png');"></button>
							</li>
							<li>
								<button class="inner_color" onclick="black();"
									style="background: url('../resources/images/estimate/i30/black-exterior.png');"></button>
							</li>
							<li>
								<button class="inner_color" onclick="red();"
									style="background: url('../resources/images/estimate/i30/red-exterior.png');"></button>
							</li>
							<li>
								<button class="inner_color" onclick="blue();"
									style="background: url('../resources/images/estimate/i30/blue-exterior.png');"></button>
							</li>
							<li>
								<button class="inner_color" onclick="gray();"
									style="background: url('../resources/images/estimate/i30/아마존그레이-exterior.png');"></button>
							</li>
						</ul>
					</div>
				</div>
