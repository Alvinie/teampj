...
function orange(){
		document.getElementById("imagess").src="../resources/images/estimate/santafe/santafe_orange.png";
}
function black(){
	document.getElementById("imagess").src="../resources/images/estimate/santafe/santafe_black.png";
}
function mforce(){
	document.getElementById("imagess").src="../resources/images/estimate/santafe/santafe_mforce.png";
}
function tsilver(){
	document.getElementById("imagess").src="../resources/images/estimate/santafe/santafe_tsilver.png";
}
function rforest(){
	document.getElementById("imagess").src="../resources/images/estimate/santafe/santafe_rforest.png";
}
			...
			<section>
				<div>
					<header>
						<div>
							<h2>싼타페 Premium</h2>
							<span style="color: gray;">싼타페 가솔린 2.0 터보 2WD 오토 Premium</span>
						</div>
						<div align="right">
							<span style="font-size: 19px;">차량 가격</span><b style="font-size: 30px; margin-left: 30px;">27,450,000 원</b>
						</div>
					</header>
				</div>
				<div align="right">
				...
				<div>
				<img id="imagess" src="../resources/images/estimate/santafe/santafe_orange.png">
				</div>
				<div>
			...
			<form  id="option" action="../prices/savePrice" method="post">
				<ul>
					...
					<li><p><b>차량 종류</b></p><select name="car">
							<option value="싼타페 가솔린 2.0 터보 2WD 오토 Premium">싼타페</option>
					</select></li>
					<br>
					<li><p><b>차량 색</b></p><select name="color">
							<option value="orange">orange</option>
							<option value="black">black</option>
							<option value="mforce">mforce</option>
							<option value="tsilver">tsilver</option>
							<option value="rforest">rforest</option>
					</select></li>
					<p><b>추가 옵션</b></p>
					<div>
			...
			<section>
				<div>
					...
					<div>
						<ul>
							<li>
								<button class="inner_color" onclick="orange();"	
									style="background: url('../resources/images/estimate/santafe/orange-exterior.png');"></button>
							</li>
							<li>
								<button class="inner_color" onclick="black();"
									style="background: url('../resources/images/estimate/santafe/black-exterior.png');"></button>
							</li>
							<li>
								<button class="inner_color" onclick="mforce();"
									style="background: url('../resources/images/estimate/santafe/mforce-exterior.png');"></button>
							</li>
							<li>
								<button class="inner_color" onclick="tsilver();"
									style="background: url('../resources/images/estimate/santafe/tsilver-exterior.png');"></button>
							</li>
							<li>
								<button class="inner_color" onclick="rforest();"
									style="background: url('../resources/images/estimate/santafe/rforest-exterior.png');"></button>
							</li>
						</ul>
					</div>
				</div>
