          ...
          <li>
             <div class="img_frame">
             	<a href="grdetail" title="그랜져">
                   ...
                   <div><a href="estimate_grangeur" title="내 차 만들기" style="padding-left: 60px; font-size: 13px;">
                   			내 차 만들기
                   		</a>
                   </div>
             	</a>
    	 ...
    	 <li class="">
            <div class="img_frame">
             	<a href="sndetail" title="소나타">
                	...
                	<div><a href="estimate_sonata" title="내 차 만들기" style="padding-left: 60px; font-size: 13px;">
                   			내 차 만들기
                   		</a>
                   </div>
             	</a>
         ...
         <li class="">
            <div class="img_frame">
             	<a href="avdetail" title="아반떼">
                	...
                	<div><a href="estimate_avante" title="내 차 만들기" style="padding-left: 60px; font-size: 13px;">
                   			내 차 만들기
                   		</a>
                   </div>
             	</a>
         ...
         <li class="">
            <div class="img_frame">
             	<a href="i3detail" title="i30">
                	...
                	<div><a href="estimate_i30" title="내 차 만들기" style="padding-left: 60px; font-size: 13px;">
                   			내 차 만들기
                   		</a>
                   </div>
             	</a>
         ...
         <li class="">
            <div class="img_frame">
             	<a href="bldetail" title="벨로스터">
                	...
                	<div><a href="estimate_veloster" title="내 차 만들기" style="padding-left: 65px; font-size: 13px;">
                   			내 차 만들기
                   		</a>
                   </div>
             	</a>
          ...
          <li>
             <div class="img_frame">
             	<a href="vndetail" title="베뉴">
                   ...
                   <div><a href="estimate_venue" title="내 차 만들기" style="padding-left: 60px; font-size: 13px;">
                   			내 차 만들기
                   		</a>
                   </div>
             	</a>
    	 ...
    	 <li class=""> 
            <div class="img_frame">
             	<a href="kndetail" title="코나">
                	...
                	<div><a href="estimate_kona" title="내 차 만들기" style="padding-left: 60px; font-size: 13px;">
                   			내 차 만들기
                   		</a>
                   </div>
             	</a>
         ...
         <li class="">
            <div class="img_frame">
             	<a href="tsdetail" title="투싼">
                	...
                	<div><a href="estimate_tucson" title="내 차 만들기" style="padding-left: 60px; font-size: 13px;">
                   			내 차 만들기
                   		</a>
                   </div>
             	</a>
         ...
         <li class="">
            <div class="img_frame">
             	<a href="stdetail" title="싼타페">
                	...
                	<div><a href="estimate_santafe" title="내 차 만들기" style="padding-left: 60px; font-size: 13px;">
                   			내 차 만들기
                   		</a>
                   </div>
             	</a>
         ...
         <li class="">
            <div class="img_frame">
             	<a href="pldetail" title="팰리셰이드">
                	...
                	<div><a href="estimate_palisade" title="내 차 만들기" style="padding-left: 60px; font-size: 13px;">
                   			내 차 만들기
                   		</a>
                   </div>
             	</a>
          ...
          <li>
             <div class="img_frame">
             	<a href="gsdetail" title="그랜드 스타렉스">
                   ...
                   <div><a href="estimate_grandstarex" title="내 차 만들기" style="padding-left: 60px; font-size: 13px;">
                   			내 차 만들기
                   		</a>
                   </div>
             	</a>
         ...
         <li class="">
            <div class="img_frame">
             	<a href="gsldetail" title="그랜드 스타랙스 Limousine">
                	...
                	<div><a href="estimate_grandstarex_limousine" title="내 차 만들기" style="padding-left: 60px; font-size: 13px;">
                   			내 차 만들기
                   		</a>
                   </div>
             	</a>
          ...
          <li>
             <div class="img_frame">
             	<a href="nxdetail" title="넥쏘">
                   ...
                   <div><a href="estimate_nexo" title="내 차 만들기" style="padding-left: 60px; font-size: 13px;">
                   			내 차 만들기
                   		</a>
                   </div>
             	</a>
    	 ...
    	 <li class="">
            <div class="img_frame">
             	<a href="ptdetail" title="포터">
                	...
                	<div><a href="estimate_porter2" title="내 차 만들기" style="padding-left: 60px; font-size: 13px;">
                   			내 차 만들기
                   		</a>
                   </div>
             	</a>
